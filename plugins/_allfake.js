...
handler.all = async function (m) {
	...
	try {
	 ...
	 message: { "liveLocationMessage": { "caption":"Created By YannzOfc","h": `${wm}`, 'jpegThumbnail': fs.readFileSync('./src/logo.jpg')}}
	}
	 ...
	 participant: `0@s.whatsapp.net`, ...(m.chat ? 
	 { remoteJid: "status@broadcast" } : {}) },
	 message: { "liveLocationMessage": { "title": "Created By YannzOfc","h": wm, 'jpegThumbnail': fs.readFileSync('./src/logo.jpg')}}
	}
		...
		message: {
			"productMessage": {
				"product": {
					...
					"title": YannzOfc, //Kasih namalu 
					"description": YanzzBot, 
					"currencyCode": "USD",
