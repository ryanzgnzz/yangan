...
const fkgif = {
	 ...
	 message: { 
		"extendedTextMessage": {
                 "text":`YanzzBot 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
                 "title": `YanzzBot 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
                 'jpegThumbnail': await (await fetch('https://telegra.ph/file/eb1e8d5bf73fc25b14d65.jpg')).buffer()
                        }
	                  } 
                     }
 ...
       const sections = [
                              {
                                "rows": [{
                                         "title": "📊 › Status ",
                                         "description": "Status カ YanzzBot",
                                         "rowId": ".botstat"
                                    }, {
                                         "title": "⚡› Speed ",
                                         "description": "Menampilkan Kecepatan Respon カ YanzzBot",
                                         "rowId": ".ping"
                                    }, {
                                         "title": "🗒️› Info ",
                                         "description": "Menampilkan Info カ YanzzBot",
                                         "rowId": ".info"
                                    }, {
                                         "title": "🎐 › Developer Bot ",
